                ...
                <div className="container leadershipContent">
                    ...
                    <div className="row d-flex justify-content-center h-75 cards">
                        <div className="col-6 cardContainer">
                            <div class="card border-light imageCard leadershipCard">
                                <div class="card-body d-flex flex-column leadershipCardBody">
                                    <img src="https://picsum.photos/seed/picsum/200/300" alt="placeholder" className="photo"></img>
                                </div>
                            </div>
                        </div>
                        <div className="col-6 cardContainer">
                            <div class="card border-light leadershipCard">
                                <div class="card-body d-flex flex-column profileCard leadershipCardBody">
